...
--
-- Host: localhost:3306
-- Generation Time: Mar 26, 2020 at 11:45 PM
...
CREATE TABLE `item` (
  ...
  `item_loc_aisle` char(10) NOT NULL DEFAULT '',
  `item_loc_column` char(10) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `item` (`item_id`, `item_item_category_id`, `item_item_style_id`, `item_sku`, `item_l`, `item_w`, `item_h`, `item_description`, `item_price`, `item_loc_aisle`, `item_loc_column`) VALUES
...
CREATE TABLE `item_style` (
  ...
  `item_style_image_cover` char(150) NOT NULL,
  `item_style_image_description` char(150) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
