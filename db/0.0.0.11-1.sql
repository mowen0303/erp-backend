...
INSERT INTO `item` (`item_id`, `item_item_category_id`, `item_item_style_id`, `item_sku`, `item_w`, `item_h`, `item_d`, `item_description`, `item_price`) VALUES
(1, 1, 1, 'W1230', 12.0000, 30.0000, 12.0000, '', 320.00),
(2, 1, 2, 'test', 0.8600, 0.1000, 0.6600, '', 0.00),
(3, 15, 6, 'W1230-BOX', 0.0000, 0.0000, 0.0000, '', 0.00);
...
INSERT INTO `item_category` (`item_category_id`, `item_category_title`, `item_category_image`) VALUES
(1, 'Wall Cabinets', '/upload/thumbnail/1_15852423565e7ce0f4118336.52938652.png'),
(2, 'Handle & Nob', ''),
(3, 'hinge', ''),
(4, 'slider', ''),
(5, 'Sink', ''),
...
INSERT INTO `item_style` (`item_style_id`, `item_style_title`) VALUES
(1, 'Shaker White'),
(2, 'Shaker Grey'),
(3, 'Concord Chestnut'),
(4, 'Willow Grey'),
...
CREATE TABLE `store` (
  ...
  `store_website` char(255) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 0, 1, 1, 'Admin', 'Super', 'superadmin', '/upload/thumbnail/1_15820820845e4ca8242e0d82.15518426.jpg', '01ff38c60e01bba644901f783753adf8', 'President', '9056708787', '', '', '', '2020-02-13 18:02:45', '2020-03-26 10:26:21', 1),
...
--
ALTER TABLE `item_category`
  MODIFY `item_category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `item_style`
--
ALTER TABLE `item_style`
  MODIFY `item_style_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
